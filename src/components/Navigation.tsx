...
const Navigation = () => {
  ...
  return (
    <div className="h-full flex">
      ...
      {/* Render the ChatSidebar when in Chat context */}
      {activePath === '/chat' && chatSidebarExpanded && (
        <div className="h-full border-r border-gray-200 dark:border-gray-800 w-60">
      ...
      {/* Render the ImageSidebar when in Images context */}
      {activePath === '/images' && imageSidebarExpanded && (
        <div className="h-full border-r border-gray-200 dark:border-gray-800 w-60">
          <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-800">
